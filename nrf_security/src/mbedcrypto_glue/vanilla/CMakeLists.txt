...
kconfig_mbedtls_debug_list_target_files(${IMAGE}mbedcrypto_vanilla)

kconfig_mbedtls_debug("######### Creating vanilla glue library #########")
...
kconfig_mbedtls_debug_list_target_files(${IMAGE}mbedcrypto_glue_vanilla)
